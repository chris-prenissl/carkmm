...
class TemplateManager: NSObject {
    ...
    private func requestLocation() {
        guard CLLocationManager.locationServicesEnabled() else {
            MemoryLogger.shared.appendEvent("Please enable location services.")
            return
        }
